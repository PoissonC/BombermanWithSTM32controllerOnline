...
def menu_loop():
    ...
    play_options.add.selector("Character 2", [("Player", Algorithm.PLAYER),("DIJKSTRA", Algorithm.DIJKSTRA), ("DFS", Algorithm.DFS),
                                              ("None", Algorithm.NONE)], onchange=change_enemy1,  default=2)
    play_options.add.selector("Character 3", [("Player", Algorithm.PLAYER),("DIJKSTRA", Algorithm.DIJKSTRA), ("DFS", Algorithm.DFS),
                                              ("None", Algorithm.NONE)], onchange=change_enemy2,  default=1)
    play_options.add.selector("Character 4", [("Player", Algorithm.PLAYER),("DIJKSTRA", Algorithm.DIJKSTRA), ("DFS", Algorithm.DFS),
                                              ("None", Algorithm.NONE)], onchange=change_enemy3,  default=1)
    play_options.add.selector("Show path", [("Yes", True), ("No", False)], onchange=change_path,  default=1)
